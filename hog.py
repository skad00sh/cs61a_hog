...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if  change > running_high:
            ...
            new_high = change
        return announce_highest(who, last_score = current_score, running_high = new_high)
    return say
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if extra_turn(score + new_score, opponent_score):
        return 0
    else:
        return bacon_strategy(score + new_score, opponent_score, cutoff, num_rolls)  # Replace this statement
    # END PROBLEM 11
